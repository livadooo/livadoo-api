...
interface MailService {
    ...
    fun sendPasswordResetRequestEmail(firstName: String, email: String, otp: String, expirationTime: Int, locale: Locale)

    fun sendPasswordResetEmail(firstName: String, email: String, locale: Locale)

    fun sendEmailChangeRequestEmail(firstName: String, email: String, otp: String, expirationTime: Int, locale: Locale)
